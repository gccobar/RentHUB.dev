...
<body>
<header data-bs-theme="alert">
  <div class="collapse text-bg-dark" id="navbarHeader">
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4>About</h4>
          <p class="text-white">Founded by Bonifacio and Virginia Kho. Initially planned as VIRBON Apartment but this Grandson of theirs wants to be aesthetic AF.. so he named it "RentHUB".</p>
        </div>
  ...
  <div class="navbar navbar-dark bg-success shadow-sm">
    <div class="container">
      <a href="#" class="navbar-brand d-flex align-items-center">
        <img src="https://uxwing.com/wp-content/themes/uxwing/download/buildings-architecture-real-estate/tenant-icon.png" alt="Tenant icon in SVG, PNG formats" title="Tenant icon" width="40" height="40">
        &nbsp;
